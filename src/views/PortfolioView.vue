      ...
      items: [
        {
          id: 1,
          name: 'Retencrypto',
          imageUrl: 'Retencrypto',
          status: ' I created RetencryptoApp Of Crypto Transfer Services.',
          tech: 'React JS, Tailwind',
          github: 'https://github.com/xaliiakkus/RetencrptoApp',
        ...
        },
        {
          id: 3,
          name: 'Doguş tekstil',
          imageUrl: 'Dogustekstile',
          status: 'Doğuş Textil has been dealing with textile and manufacturing since 1996 ',
          tech: 'React JS , CSS3 ',
          github: 'https://github.com/xaliiakkus/dogusTextilGroup',
          demo: 'null'
        },
        {
          id: 4,
          ...
          imageUrl: 'Startup',
          status: 'Startups co-founders who have a way to solve a problem. The founder of a startup will begin market validation .',
          tech: 'Nuxt , TailwindCss',
          github: 'https://github.com/xaliiakkus/StartUp-App',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Cars hup',
          imageUrl: 'carshup',
          status: 'Find, book, rent a car—quick and super , easy! Streamline your car rental experience with our effortless booking process',
          tech: 'Next JS TailwindCss',
          github: 'https://github.com/xaliiakkus/caars',
          demo: 'https://caars.vercel.app/'
        }
      ]
    };
  }
