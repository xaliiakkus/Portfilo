      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="../assets/avatar.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is I am Ali Akkuş. I am a Middle Frontend Developer
            I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that
            has
            aesthetic value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp;  I have been creating designs professionally for 5 years.
            I Have 4.5 Years of Work Experience, I Worked in Teams and Made Contributions
          </p>
        </div>
